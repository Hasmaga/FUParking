...
namespace FUParkingModel.RequestObject.Vehicle
{
    public class CreateCustomerVehicleReqDto
    {
        ...
        [FromForm(Name = "HeadImage")]
        [FileSize(MaxFileSize)]
        [ValidateImageContentType]
        [Required(ErrorMessage = "Must have Head Image")]
        public IFormFile HeadImage { get; set; } = null!;

        [FromForm(Name = "BodyImage")]
        [FileSize(MaxFileSize)]
        [ValidateImageContentType]
        [Required(ErrorMessage = "Must have Body Image")]
        public IFormFile BodyImage { get; set; } = null!;
    }
