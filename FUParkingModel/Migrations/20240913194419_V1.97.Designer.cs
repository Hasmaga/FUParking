...
namespace FUParkingModel.Migrations
{
    ...
    [Migration("20240913194419_V1.97")]
    partial class V197
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FUParkingModel.Object.Session", b =>
                {
                    ...
                    b.Property<string>("ImageInBodyUrl")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("ImageInBodyUrl");
                    ...
                    b.Property<string>("ImageOutBodyUrl")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("ImageOutBodyUrl");
            ...
            modelBuilder.Entity("FUParkingModel.Object.Transaction", b =>
                {
                    ...
                    b.Property<Guid?>("UserTopUpId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("UserTopUpId");
            ...
            modelBuilder.Entity("FUParkingModel.Object.VehicleType", b =>
                {
                    ...
                    b.Property<string>("StatusVehicleType")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("StatusVehicleType");
            ...
            modelBuilder.Entity("FUParkingModel.Object.Transaction", b =>
                {
                    ...
                    b.HasOne("FUParkingModel.Object.User", "UserTopUp")
                        .WithMany("TransactionTopUpBys")
                        .HasForeignKey("UserTopUpId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("FUParkingModel.Object.User", b =>
                {
                    ...
                    b.Navigation("TransactionTopUpBys");
